      ...
      <div class="main-sidebar sidebar-style-2">
        <aside id="sidebar-wrapper">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="dropdown <?php echo $this->uri->segment(2) == 'user' ? 'active' : ''; ?>">
              <a href="#" class="nav-link has-dropdown"><i class="fas fa-user-friends"></i>User</span></a>
              <ul class="dropdown-menu">
                <li class="<?php echo $this->uri->segment(3) == 'user-puskesmas' ? 'active' : ''; ?>"><a class="nav-link" href="<?php echo base_url(); ?>admin/user/user-puskesmas">User Puskesmas</a></li>
                <li class="<?php echo $this->uri->segment(3) == 'user-pusat'  ? 'active' : ''; ?>"><a class="nav-link" href="<?php echo base_url(); ?>admin/user/user-pusat">User Pusat</a></li>
              </ul>
            </li>
